      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-24 sm:py-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          <div className="max-w-3xl">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display text-white mb-6 sm:mb-8 leading-[1.15] drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
              Discover Bern. Understand Switzerland.
            </h1>

            <p className="text-lg sm:text-xl md:text-2xl text-white mb-8 sm:mb-10 max-w-2xl leading-relaxed font-light drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
              See beyond the monuments — and discover how this country really works.
            </p>

            <p className="text-base sm:text-lg text-white/95 mb-5 sm:mb-6 max-w-2xl leading-relaxed font-light drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
              Free & Private Walking Tours with honest local insight.
            </p>

            <p className="text-sm sm:text-base text-white/90 mb-10 sm:mb-12 max-w-2xl leading-relaxed font-light drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)]">
